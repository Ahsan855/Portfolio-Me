        ...
        <div class="container px-5 py-24 mx-auto">
          <div class="flex flex-wrap w-full mb-20">
            <div class="lg:w-1/2 w-full mb-6 lg:mb-0">
              <h1 class="sm:text-3xl font-bold text-2xl title-font mb-2 text-gray-900">
                My <span className="border-b-4 border-primary">Projects</span>
              </h1>
            </div>
            <p class="lg:w-1/3 w-full leading-relaxed text-gray-500">
          ...
          <div class="flex flex-wrap -m-4">
            <div class="xl:w-1/4 md:w-1/2 text-left p-4">
              <div class="bg-gray-100 p-6 rounded-lg">
                <img
                  ...
                  alt="content"
                />
                <h3 class="tracking-wides text-sm font-medium title-font">
                  <span className="text-primary">Used:</span>
                  firebase,react,firebase hooks,tailwind,MongoDb,Nodejs
                </h3>
                <h2 class="text-lg text-primary font-medium title-font mb-4">
            ...
            <div class="xl:w-1/4 md:w-1/2 p-4 text-left">
              <div class="bg-gray-100 p-6 rounded-lg">
                <img
                  class="h-40 rounded w-full object-cover object-center mb-6"
                  src={image2}
